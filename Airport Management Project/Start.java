	...
	public static void main (String args[])
	{
		...
		while (repeat)
		{
			...
			switch(choice)
			{
				case 1:
					...
					switch(option1)
					{
						case 1:
					        ...
					        {
								System.out.println("------------------------");
						        System.out.println("Empolyee Inserted With ID : "+e1.getEid());
								System.out.println("------------------------");
					        }
					        else
					        {
						...
						case 2:
                            ...
                            if(e2 != null)
							{
								...
								{
									System.out.println("Employee Removed with ID : "+e2.getEid());
									System.out.println("------------------------");
							    }
								else
								{
				...
				case 2:
					System.out.println("------------------------");
					System.out.println("You Have Chosen Flight Management.");
					System.out.println("------------------------");
					...
					switch(option2)
					{
						case 1:
						    System.out.println("------------------------");
							System.out.println("You Have Chosen to Insert A Flight");
							System.out.println("------------------------");
							...
							{
								System.out.println("Flight Inserted with ID: "+f1.getFid());
								System.out.println("------------------------");
						    }
							else
							{
								System.out.println("Flight can not be inserted");
								System.out.println("------------------------");
						    }
						...
						case 2:
						    System.out.println("------------------------");
					        System.out.println("You have chosen to Remove an Existing Flight.");
					        System.out.println("------------------------");
                            ...
                            if(f2 != null)
							{
								...
								{
									System.out.println("Flight Removed with ID : "+f2.getFid());
									System.out.println("------------------------");
							    }
								else
								{
									System.out.println("Flight Can Not be Removed.");
									System.out.println("------------------------");
								}
							}
                            else
						...
						case 3:
							System.out.println("------------------------");
							System.out.println("You Have Chosen See All Flight.");
							System.out.println("------------------------");
							a.showAllFlights();
							break;
						...
						case 4:
							System.out.println("------------------------");
							System.out.println("You Have Chosen to Search Flight");
							System.out.println("------------------------");
							...
							if(f3 != null)
							{
								...
								System.out.println("Flight ID : "+f3.getFid());
								System.out.println("Flight Name : "+f3.getName());
				...
				case 3:
				    System.out.println("------------------------");
					System.out.println("You have chosen Flight Ticket Management.");
					System.out.println("------------------------");
					...
					switch(option3)
					{
						case 1:
							...
							System.out.println("------------------------");
							System.out.println("You have chose to Insert a Ticket for a Flight.");
							System.out.println("------------------------");
					    ...
					    case 2:
						    ...
						    System.out.println("------------------------");
							System.out.println("You Have Chosen to Remove an Existing Ticket.");
							System.out.println("------------------------");
					    ...
					    case 3:
							System.out.println("------------------------");
							System.out.println("You Have Chosen See All Tickets.");
							System.out.println("------------------------");
						...
						case 4:
							System.out.println("------------------------");
							System.out.println("You Have Chosen to Search a Ticket.");
							System.out.println("------------------------");
				...
				case 4:
					System.out.println("------------------------");
					System.out.println("You Have Chosen Ticket Quantity Add-sell.");
					System.out.println("------------------------");
					...
					switch(option4)
					{
						...
						case 2:
						    System.out.println("------------------------");
							System.out.println("You Choose to Sell a Ticket.");
							System.out.println("------------------------");
							...
							if(a.searchFlight(fId6) != null)
							{
								...
								if(a.searchFlight(fId6).searchTicket(tId1) != null)
								{
									...
									{
										System.out.println("Cannot be Sell");
										System.out.println("------------------------");
									}
								}
								else
